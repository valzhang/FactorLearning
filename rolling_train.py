...
import logzero
log_file = 'D:\\Log'
logger1 = logzero.setup_logger(name='mylogger1', logfile=os.path.join(log_file, 'rolling_train.log'))
...
def main(argv):
    ...
    all_df = LoadAllData(filename=data_filename, uni_name=uni_name, from_date=20060101, to_date=20190501)
    ...
    for test_year in range(2012, 2020):
        from_date = (test_year - 6) * 10000 + 101
        train_last_date = test_year * 10000 + 101
        to_date = test_year * 10000 + 1231
        classifier.train(
